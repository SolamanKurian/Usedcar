        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 sm:pb-16">
          <div className="grid grid-cols-3 gap-2 sm:gap-6">
            ...
            <div className="group relative w-full transition-transform duration-300 hover:-translate-y-0.5">
              <div className="p-[1px] rounded-xl sm:rounded-2xl bg-gradient-to-br from-yellow-500/40 via-orange-500/30 to-red-500/40">
                <div className="text-center p-3 sm:p-5 bg-gray-900/30 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/10 hover:border-white/30 hover:bg-gray-900/40 transition-all duration-300 shadow-none sm:shadow-xl">
                  <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-4 shadow-lg shadow-yellow-500/20">
                    <svg className="w-5 h-5 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-lg sm:text-2xl font-bold text-white mb-1 sm:mb-2">1000+</h3>
                  <p className="text-xs sm:text-sm text-yellow-200">Quality Cars</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative w-full transition-transform duration-300 hover:-translate-y-0.5">
              <div className="p-[1px] rounded-xl sm:rounded-2xl bg-gradient-to-br from-yellow-500/40 via-orange-500/30 to-red-500/40">
                <div className="text-center p-3 sm:p-5 bg-gray-900/30 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/10 hover:border-white/30 hover:bg-gray-900/40 transition-all duration-300 shadow-none sm:shadow-xl">
                  <div className="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-4 shadow-lg shadow-red-500/20">
                    <svg className="w-5 h-5 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                  <h3 className="text-lg sm:text-2xl font-bold text-white mb-1 sm:mb-2">5000+</h3>
                  <p className="text-xs sm:text-sm text-yellow-200">Happy Customers</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative w-full transition-transform duration-300 hover:-translate-y-0.5">
              <div className="p-[1px] rounded-xl sm:rounded-2xl bg-gradient-to-br from-yellow-500/40 via-orange-500/30 to-red-500/40">
                <div className="text-center p-3 sm:p-5 bg-gray-900/30 backdrop-blur-md rounded-xl sm:rounded-2xl border border-white/10 hover:border-white/30 hover:bg-gray-900/40 transition-all duration-300 shadow-none sm:shadow-xl">
                  ...
                  <h3 className="text-lg sm:text-2xl font-bold text-white mb-1 sm:mb-2">24/7</h3>
                  <p className="text-xs sm:text-sm text-yellow-200">Support</p>
                </div>
              </div>
            </div>
          </div>
