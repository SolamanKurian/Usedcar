...
export default function AddFuelType() {
  ...
  const fetchExistingFuelTypes = async () => {
    try {
      ...
      const fuelTypesData = fuelTypesSnapshot.docs.map(doc => doc.data().name.toLowerCase());
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addDoc(collection(db!, 'fuelTypes'), fuelTypeData);
      router.push('/admin/fuel-types');
    } catch (error) {
      console.error('Error adding fuel type:', error);
      setError('Failed to add fuel type. Please try again.');
    } finally {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center justify-between flex-1">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Create a new fuel type for your products</p>
                </div>
                <Link
                  href="/admin/fuel-types"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? 'Adding...' : 'Add Fuel Type'}
                  </button>
                </div>
              </form>
            </div>
