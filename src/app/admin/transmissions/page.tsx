...
export default function TransmissionsManagement() {
  ...
  const [transmissionToDelete, setTransmissionToDelete] = useState<Transmission | null>(null);
  ...
  const handleDeleteClick = (transmission: Transmission) => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      setDeleteLoading(transmissionToDelete.id);
      await deleteDoc(doc(db!, 'transmissions', transmissionToDelete.id));
      setTransmissions(transmissions.filter(transmission => transmission.id !== transmissionToDelete.id));
                  ...
                  <li key={transmission.id}>
                    <div className="px-6 py-4 flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() => handleDeleteClick(transmission)}
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete "{transmissionToDelete?.name}"? This action cannot be undone.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  disabled={deleteLoading === transmissionToDelete?.id}
                  className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50"
                >
                  {deleteLoading === transmissionToDelete?.id ? 'Deleting...' : 'Delete'}
                </button>
                <button
                  type="button"
