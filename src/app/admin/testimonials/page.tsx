  ...
  const handleToggleStatus = async (testimonialId: string, currentStatus: boolean) => {
    try {
      ...
      setTestimonials(prev => prev.map(t => 
        t.id === testimonialId 
          ? { ...t, isActive: !currentStatus, updatedAt: new Date() }
          : t
      ));
    } catch (error) {
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Firebase is not configured. Please set up your environment variables to access testimonials management.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add, edit, and manage client testimonials</p>
                </div>
              </div>
              <Link
            ...
            {loadingTestimonials ? (
              ...
              <div className="divide-y divide-gray-200">
                {testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="p-6 hover:bg-gray-50 transition-colors duration-200">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-3">{testimonial.message}</p>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span>Created: {testimonial.createdAt.toLocaleDateString()}</span>
                          <span>Updated: {testimonial.updatedAt.toLocaleDateString()}</span>
                        </div>
                      </div>
                      <div className="flex space-x-2 ml-4">
                        ...
                        >
                          {updatingStatus === testimonial.id ? 'Updating...' : (testimonial.isActive ? 'Deactivate' : 'Activate')}
                        </button>
                        <Link
