        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Firebase is not configured. Please set up your environment variables to access brand management.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add, edit, and manage vehicle brands</p>
                </div>
              </div>
              <Link
            ...
            {loadingBrands ? (
              ...
              <div className="divide-y divide-gray-200">
                {brands.map((brand, index) => (
                  <div key={brand.id} className="p-4 hover:bg-gray-50 transition-colors duration-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-sm text-gray-500">Brand ID: {brand.id.slice(0, 8)}...</p>
                        </div>
                      </div>
                      <div className="flex space-x-2">
                        ...
                        >
                          {deletingBrand === brand.id ? 'Deleting...' : 'Delete'}
                        </button>
                      </div>
                    </div>
                  </div>
