...
export default function AddCategory() {
  ...
  const fetchExistingCategories = async () => {
    try {
      ...
      const categoriesData = categoriesSnapshot.docs.map(doc => doc.data().name.toLowerCase());
  ...
  const validateForm = () => {
    ...
    if (existingCategories.includes(formData.name.trim().toLowerCase())) {
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Firebase is not configured. Please set up your environment variables to access category management.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center justify-between flex-1">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Create a new category for your products</p>
                </div>
                <Link
                  href="/admin/categories"
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      placeholder="Enter category name (e.g., Sedan, SUV, Truck)"
