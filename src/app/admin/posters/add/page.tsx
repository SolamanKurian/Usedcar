        ...
        <div className="flex-1 p-4 lg:p-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900">Add New Poster</h1>
                </div>
                <p className="text-gray-600">Create a new poster for the landing page</p>
              </div>
              <Link
                href="/admin/posters"
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600">Fill in the details below to add your new poster</p>
            </div>
            ...
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  />
                  <p className="text-sm text-gray-500">
                    Upload a high-quality image for the landing page poster. The image will be cropped to maintain 16:9 aspect ratio.
                  </p>
                </div>
